...
int main(int argc, char** argv) {
  ...
  save(build_hamburger(), out, "01_hamburger_marketshare.json");
  save(build_tree134(), out, "02_ahp_best_car.json");
  save(build_network23(), out, "03_anp_network23_feedback.json");
  save(build_benefits_costs(), out, "04_bcr_benefits_costs_plans.json");
  save(build_ratings_demo(), out, "05_ratings_price_quality.json");
  save(build_best_house(), out, "06_ahp_best_house.json");
  save(build_school_choice(), out, "07_ahp_school_choice.json");
  save(build_vacation(), out, "08_ahp_vacation.json");
  save(build_job_offer(), out, "09_ahp_job_offer.json");
  save(build_car_bcr(), out, "10_bcr_car_purchase.json");
  save(build_bocr_launch(), out, "11_bocr_product_launch.json");
  save(build_bridge(), out, "12_anp_bridge_feedback.json");
  save(build_laptop(), out, "13_ahp_laptop.json");
  save(build_supplier(), out, "14_ahp_supplier_selection.json");
